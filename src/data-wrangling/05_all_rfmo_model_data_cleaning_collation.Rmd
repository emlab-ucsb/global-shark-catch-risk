...
# SDM data
all_sdm_1x1 <- read.csv(file.path(here::here(), "data/iucn-sdm-data/outputs/global_combined_iucn_sdm_1x1.csv"))
all_sdm_5x5 <- read.csv(file.path(here::here(), "data/iucn-sdm-data/outputs/global_combined_iucn_sdm_5x5.csv"))

# SST data
sst_data_1x1 <- read.csv(file.path(here::here(), "data/sea-surface-temperature/outputs/binned_global_sst_1x1.csv"))
sst_data_5x5 <- read.csv(file.path(here::here(), "data/sea-surface-temperature/outputs/binned_global_sst_5x5.csv"))

# SSH data
ssh_data_1x1 <- read.csv(file.path(here::here(), "data/sea-surface-height/outputs/binned_global_ssh_1x1.csv"))
ssh_data_5x5 <- read.csv(file.path(here::here(), "data/sea-surface-height/outputs/binned_global_ssh_5x5.csv"))

# Chlorophyll-A data
chla_data_1x1 <- read.csv(file.path(here::here(), "data/chlorophyll-a/outputs/binned_global_chla_1x1.csv"))
chla_data_5x5 <- read.csv(file.path(here::here(), "data/chlorophyll-a/outputs/binned_global_chla_5x5.csv"))

# GFW data
gfw_data_1x1 <- read.csv(file.path(here::here(), "data/global-fishing-watch/outputs/binned_global_gfw_1x1.csv"))
gfw_data_5x5 <- read.csv(file.path(here::here(), "data/global-fishing-watch/outputs/binned_global_gfw_5x5.csv"))

# Ex-vessel price data
prices <- read.csv(file.path(here::here(), "data/ex-vessel-prices/exvessel_price_database_1976_2017.csv")) %>% 
  distinct_all()
...
write.csv(combined_data,
          file.path(here::here(), 
          paste0("data/model-data/inputs/all-rfmo-models/", rfmos, "_ll_data_1x1_tuna_hooks.csv")),
          row.names = FALSE)
