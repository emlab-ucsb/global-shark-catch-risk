...
# Load data
# 1x1 data - count only
list_files<- c(list.files(file.path(here::here(), "data/model-data/inputs/all-rfmo-models/", pattern = "1x1_mt_to_count_hooks.csv"), full.names = T), file.path(here::here(), "data/model-data/inputs/all-rfmo-models/WCPFC_ll_data_1x1_count_hooks.csv"))
...
list_files <- c(list.files(file.path(here::here(), "data/model-data/inputs/all-rfmo-models/", pattern = "1x1_mt_to_count_kwh.csv"), full.names = T), 
                file.path(here::here(), "data/model-data/inputs/all-rfmo-models/WCPFC_ll_data_1x1_count_kwh.csv"))
