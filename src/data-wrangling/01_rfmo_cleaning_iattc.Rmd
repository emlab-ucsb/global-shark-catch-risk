...
file_path <- file.path(here::here(), "data-updated/rfmo-data/inputs/iattc/")
save_location <- file.path(here::here(),"data-updated/rfmo-data/intermediates/iattc/")
...
```{r, echo=TRUE}
# Select only data from year 2012 onward
...
PublicLLSharkMt <- PublicLLSharkMt %>% 
  mutate(rfmo = "IATTC", 
         ...
         quality_code = NA, 
         was_generated = "no", 
         sources = "PublicLLSharkMt")

# Re-order columns
PublicLLSharkMt <- PublicLLSharkMt[,c("rfmo", "year", "month", "time_period", "country", "gear", "settype", "longitude", "latitude", "effort", "effort_units", "species_commonname", "species_sciname", "catch", "catch_units", "spatial_notes", "quality_code", "was_generated", "sources")]
...
PublicLLSharkNum <- PublicLLSharkNum %>% 
  mutate(rfmo = "IATTC", 
         ...
         quality_code = NA, 
         was_generated = "no", 
         sources = "PublicLLSharkNum")

# Re-order columns
PublicLLSharkNum <- PublicLLSharkNum[,c("rfmo", "year", "month", "time_period", "country", "gear", "settype", "longitude", "latitude", "effort", "effort_units", "species_commonname", "species_sciname", "catch", "catch_units", "spatial_notes", "quality_code", "was_generated", "sources")]
...
PublicLLTunaBillfishMt <- PublicLLTunaBillfishMt %>% 
  mutate(rfmo = "IATTC", 
         ...
         quality_code = NA, 
         was_generated = "no", 
         sources = "PublicLLTunaBillfishMt")

# Re-order columns
PublicLLTunaBillfishMt <- PublicLLTunaBillfishMt[,c("rfmo", "year", "month", "time_period", "country", "gear", "settype", "longitude", "latitude", "effort", "effort_units", "species_commonname", "species_sciname", "catch", "catch_units", "spatial_notes", "quality_code", "was_generated", "sources")]
...
PublicLLTunaBillfishNum <- PublicLLTunaBillfishNum %>% 
  mutate(rfmo = "IATTC", 
         ...
         quality_code = NA, 
         was_generated = "no", 
         sources = "PublicLLTunaBillfishNum")

# Re-order columns
PublicLLTunaBillfishNum <- PublicLLTunaBillfishNum[,c("rfmo", "year", "month", "time_period", "country", "gear", "settype", "longitude", "latitude", "effort", "effort_units", "species_commonname", "species_sciname", "catch", "catch_units", "spatial_notes", "quality_code", "was_generated", "sources")]
...
PublicPSBillfishFlag <- PublicPSBillfishFlag %>% 
  mutate(rfmo = "IATTC", 
         ...
         quality_code = NA, 
         was_generated = "no", 
         sources = "PublicPSBillfishFlag")

# Re-order columns
PublicPSBillfishFlag <- PublicPSBillfishFlag[,c("rfmo", "year", "month", "time_period", "country", "gear", "settype", "longitude", "latitude", "effort", "effort_units", "species_commonname", "species_sciname", "catch", "catch_units", "spatial_notes", "quality_code", "was_generated", "sources")]
...
PublicPSBillfishSetType <- PublicPSBillfishSetType %>% 
  mutate(rfmo = "IATTC", 
         ...
         quality_code = NA, 
         was_generated = "no", 
         sources = "PublicPSBillfishSetType")

# Re-order columns
PublicPSBillfishSetType <- PublicPSBillfishSetType[,c("rfmo", "year", "month", "time_period", "country", "gear", "settype", "longitude", "latitude", "effort", "effort_units", "species_commonname", "species_sciname", "catch", "catch_units", "spatial_notes", "quality_code", "was_generated", "sources")]
# Generate Data
# Generate quarterly data (aggregates)
...
PublicPSSharkFlag_mt <- PublicPSSharkFlag_mt %>% 
  mutate(rfmo = "IATTC", 
         ...
         quality_code = NA, 
         was_generated = "no", 
         sources = "PublicPSSharkFlag")

# Re-order columns
PublicPSSharkFlag_mt <- PublicPSSharkFlag_mt[,c("rfmo", "year", "month", "time_period", "country", "gear", "settype", "longitude", "latitude", "effort", "effort_units", "species_commonname", "species_sciname", "catch", "catch_units", "spatial_notes", "quality_code", "was_generated", "sources")]
...
PublicPSSharkFlag_n <- PublicPSSharkFlag_n %>% 
  mutate(rfmo = "IATTC", 
         ...
         quality_code = NA, 
         was_generated = "no", 
         sources = "PublicPSSharkFlag_n")

# Re-order columns
PublicPSSharkFlag_n <- PublicPSSharkFlag_n[,c("rfmo", "year", "month", "time_period", "country", "gear", "settype", "longitude", "latitude", "effort", "effort_units", "species_commonname", "species_sciname", "catch", "catch_units", "spatial_notes", "quality_code", "was_generated", "sources")]
...
PublicPSSharkSetType_mt <- PublicPSSharkSetType_mt %>% 
  mutate(rfmo = "IATTC", 
         ...
         quality_code = NA, 
         was_generated = "no", 
         sources = "PublicPSSharkSetType")

# Re-order columns
PublicPSSharkSetType_mt <- PublicPSSharkSetType_mt[,c("rfmo", "year", "month", "time_period", "country", "gear", "settype", "longitude", "latitude", "effort", "effort_units", "species_commonname", "species_sciname", "catch", "catch_units", "spatial_notes", "quality_code", "was_generated", "sources")]
...
PublicPSSharkSetType_n <- PublicPSSharkSetType_n %>% 
  mutate(rfmo = "IATTC", 
         ...
         quality_code = NA, 
         was_generated = "no", 
         sources = "PublicPSSharkSetType_n")

# Re-order columns
PublicPSSharkSetType_n <- PublicPSSharkSetType_n[,c("rfmo", "year", "month", "time_period", "country", "gear", "settype", "longitude", "latitude", "effort", "effort_units", "species_commonname", "species_sciname", "catch", "catch_units", "spatial_notes", "quality_code", "was_generated", "sources")]
...
PublicPSTunaFlag <- PublicPSTunaFlag %>% 
  mutate(rfmo = "IATTC", 
         ...
         quality_code = NA, 
         was_generated = "no", 
         sources = "PublicPSTunaFlag")

# Re-order columns
PublicPSTunaFlag <- PublicPSTunaFlag[,c("rfmo", "year", "month", "time_period", "country", "gear", "settype", "longitude", "latitude", "effort", "effort_units", "species_commonname", "species_sciname", "catch", "catch_units", "spatial_notes", "quality_code", "was_generated", "sources")]
...
PublicPSTunaSetType <- PublicPSTunaSetType %>% 
  mutate(rfmo = "IATTC", 
         ...
         quality_code = NA, 
         was_generated = "no", 
         sources = "PublicPSTunaSetType")

# Re-order columns
PublicPSTunaSetType <- PublicPSTunaSetType[,c("rfmo", "year", "month", "time_period", "country", "gear", "settype", "longitude", "latitude", "effort", "effort_units", "species_commonname", "species_sciname", "catch", "catch_units", "spatial_notes", "quality_code", "was_generated", "sources")]
