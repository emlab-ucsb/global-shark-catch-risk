...
input_loc <- file.path(here::here(), "data/model-data/outputs/all-rfmo-models/")
```
...
ggsave(file.path(here::here(), "figures/intermediates/cellbycell_sppbyspp_perc_difference.png"), width = 14, height = 6, units = "in", bg = "white")
```

![](../../figures/intermediates/cellbycell_sppbyspp_perc_difference.png)
...
ggsave(file.path(here::here(), "figures/intermediates/cellbycell_perc_difference.png"), width = 14, height = 6, units = "in", bg = "white")
```

![](../../figures/intermediates/cellbycell_perc_difference.png)
...
ggsave(file.path(here::here(), "figures/intermediates/total_perc_difference.png"), width = 14, height = 6, units = "in", bg = "white")
```

![](../../figures/intermediates/total_perc_difference.png)
