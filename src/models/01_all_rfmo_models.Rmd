...
all_rfmo_other_models(data = count_5x5_obs, rfmos = "IOTC", effort_source = "effort reported with bycatch (flag)", 
                           save_loc = save_loc)
...
# IOTC - 5x5 count only | mean_sst, mean_cv | effort reported with bycatch (flag)
iotc_effort_variables <- paste0(colnames(count_5x5_obs)[grepl("bycatch_total_effort_", colnames(count_5x5_obs))], collapse = "|")

all_rfmo_tuned_models(data = count_5x5_obs, rfmos = "IOTC", 
                      effort_source = "effort reported with bycatch (flag)", 
                      classification_variables = 
                        paste0("species_commonname|sdm|mean_sst|mean_chla|",
...
# WCPFC - 5x5 count only | mean_sst, mean_cv | effort reported with bycatch (flag) [note that bycatch effort by flag is not reported for wcpfc]
all_rfmo_tuned_models(data = count_5x5_obs, 
                rfmos = "WCPFC", 
                effort_source = "effort reported with bycatch (flag)", 
                classification_variables = "species_commonname|sdm|mean_sst|mean_chla|bycatch_total_effort", 
                regression_variables = "species_commonname|sdm|mean_sst|mean_chla|bycatch_total_effort", 
                save_loc = save_loc)
