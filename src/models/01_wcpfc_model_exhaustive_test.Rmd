...
source("../functions/func-run_wcpfc_model_final.R")
...
# The best model uses self-reported effort by flag + year 
...
# The best model uses mean sst, mean chl-a, no ssh data, no price data, and no catch transformation
run_wcpfc_model_final(data = all_dat, save_loc = save_loc)
```