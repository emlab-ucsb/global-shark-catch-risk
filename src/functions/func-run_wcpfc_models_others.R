## Run WCPFC-specific model scenario - Environmentals and Other Options
...
run_wcpfc_models_others <- function(data, save_loc){
  ...
  write.csv(final_metrics_total, paste0(save_loc, "wcpfc_models_others_results.csv"), row.names = FALSE)
} 